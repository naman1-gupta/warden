...
export class ExecError extends Error {
    ...
    stderr;
    signal;
    constructor(command, exitCode, stderr, signal) {
 ...
 */
export function execNonInteractive(command, options) {
 ...
 * @throws ExecError if the command fails
 */
export function execFileNonInteractive(file, args, options) {
    const spawnOptions = buildSpawnOptions(options);
 ...
 * @throws ExecError if the command fails
 */
export function execGitNonInteractive(args, options) {
    const env = {
        ...options?.env,
