 ...
 */
function mockBranchDetection(existingBranches, options) {
    return (cmd) => {
...
describe('getDefaultBranch', () => {
    ...
    it('returns remote HEAD symbolic ref when no branches exist', () => {
        mockExecNonInteractive.mockImplementation(mockBranchDetection([], { remoteHead: 'refs/remotes/origin/main' }));
        expect(getDefaultBranch()).toBe('origin/main');
    });
...
describe('getCommitMessage', () => {
    it('returns subject and body from commit', () => {
        mockExecNonInteractive.mockImplementation((cmd) => {
