...
import { formatCost, formatDuration, formatLocation, formatFindingCountsPlain, formatProgress, truncate, padRight, formatStatsCompact, formatSeverityBadge, } from './formatters.js';
...
describe('formatStatsCompact', () => {
    ...
    it('includes auxiliary costs in total when provided', () => {
        ...
        expect(formatStatsCompact(15800, usage, auxiliaryUsage)).toBe('⏱ 15.8s · 3.0k in / 680 out · $0.01 (+extraction: $0.00)');
    });
