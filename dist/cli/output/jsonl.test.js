...
import { writeJsonlReport, getRunLogsDir, generateRunLogFilename, getRunLogPath, } from './jsonl.js';
...
describe('getRunLogPath', () => {
    ...
    it('returns full path combining logs dir and filename', () => {
        ...
        expect(result).toBe(join(homedir(), '.local', 'warden', 'runs', 'warden_2026-01-29T14-32-15.123Z.jsonl'));
    });
